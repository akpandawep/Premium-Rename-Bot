...
class Config(object):
    ...
    DB_URL  = os.environ.get("DB_URL","mongodb+srv://bharathkalladi38:JWdbdJAsH3q9IUaj@cluster0.wvsv51o.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0") #⚠️ Required
